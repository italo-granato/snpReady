...
$$P(x_{ij})= 2p_j$$
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;In this section we are goint to present a basic usage for `raw.data` in a maize data set. It is composed of 64 inbred lines genotyped with 539 SNPs. First, let's run a basic quality control on this data set.  
